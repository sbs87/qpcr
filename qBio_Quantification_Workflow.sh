...
python /Users/$ROOT/bin/qpcr/qBio_Map_QC.py temp_formatted_results $OUTFILE $OUTFILE_CONTROL $PLOTFILE $SOURCEFILE
...
python /Users/$ROOT/bin/qpcr/qBio_Quantify.py temp_quant_input "/Users/$ROOT/bin/qpcr/dCt_threshold" $OUTFILE_QUANT_BAC $OUTFILE_QUANT_HUM
